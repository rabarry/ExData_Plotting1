...
# plot 2
# line graph of y- global active power by x- date-time

png("plot2.png", 480, 480)
plot(as.POSIXct(filteredTable$Date, time = filteredTable$Time),filteredTable$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power (kilowatts)")
dev.off()
