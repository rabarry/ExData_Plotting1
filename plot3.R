...
# plot 3
# line graph of all 3 submeterings on y axis vs datetime on x axis
# sm1 is black, sm2 red, sm3 blue
# legend of all 3 in upper right corner

png("plot3.png", 480, 480)

# print 3 graphs overlayed
